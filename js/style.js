...
// show list subject
const btnMore = document.querySelector(".fascinating-books__more-btn");
const listSubject = document.querySelector(".fascinating-books__more-list");
...
btnMore.onclick = () => {
  listSubject.classList.toggle("show");
};
